...
import com.improvementsolutions.repository.InventoryAcontecimientoTypeRepository;
...
public class InventoryAcontecimientoTypeService {

    private final InventoryAcontecimientoTypeRepository repository;

    private EppCatalogDto toDto(InventoryAcontecimientoType entity) {
    ...
    public EppCatalogDto create(EppCatalogDto input) {
        ...
        InventoryAcontecimientoType entity = new InventoryAcontecimientoType();
        entity.setName(name);
