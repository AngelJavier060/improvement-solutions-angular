...
import com.improvementsolutions.repository.EppFamilyRepository;
...
public class EppFamilyService {

    private final EppFamilyRepository repository;

    private EppCatalogDto toDto(EppFamily entity) {
    ...
    public EppCatalogDto create(EppCatalogDto input) {
        ...
        EppFamily entity = new EppFamily();
        entity.setName(name);
        entity.setCode(code);
