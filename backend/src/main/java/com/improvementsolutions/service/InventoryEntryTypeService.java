...
import com.improvementsolutions.repository.InventoryEntryTypeRepository;
...
public class InventoryEntryTypeService {

    private final InventoryEntryTypeRepository repository;

    private EppCatalogDto toDto(InventoryEntryType entity) {
    ...
    public EppCatalogDto create(EppCatalogDto input) {
        ...
        InventoryEntryType entity = new InventoryEntryType();
        entity.setName(name);
