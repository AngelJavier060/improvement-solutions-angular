...
import com.improvementsolutions.service.InventoryEstadoEpiService;
...
@RestController
@RequestMapping("/api/inventory-estado-epi")
@RequiredArgsConstructor
public class InventoryEstadoEpiController {

    private final InventoryEstadoEpiService service;
