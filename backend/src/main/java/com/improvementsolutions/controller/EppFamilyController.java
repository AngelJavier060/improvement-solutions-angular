...
import com.improvementsolutions.service.EppFamilyService;
...
@RestController
@RequestMapping("/api/epp-families")
@RequiredArgsConstructor
public class EppFamilyController {

    private final EppFamilyService service;
