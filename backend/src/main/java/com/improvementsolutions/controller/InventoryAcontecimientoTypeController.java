...
import com.improvementsolutions.service.InventoryAcontecimientoTypeService;
...
@RestController
@RequestMapping("/api/inventory-acontecimiento-types")
@RequiredArgsConstructor
public class InventoryAcontecimientoTypeController {

    private final InventoryAcontecimientoTypeService service;
