...
import com.improvementsolutions.service.InventoryOutputTypeService;
...
@RestController
@RequestMapping("/api/inventory-output-types")
@RequiredArgsConstructor
public class InventoryOutputTypeController {

    private final InventoryOutputTypeService service;
