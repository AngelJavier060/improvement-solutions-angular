...
import com.improvementsolutions.service.EppSectionService;
...
@RestController
@RequestMapping("/api/epp-sections")
@RequiredArgsConstructor
public class EppSectionController {

    private final EppSectionService service;
