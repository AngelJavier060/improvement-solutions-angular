...
@Component({
  selector: 'app-editar-horario-circulacion',
  templateUrl: './editar-horario-circulacion.component.html',
  styleUrls: ['./editar-horario-circulacion.component.scss']
})
export class EditarHorarioCirculacionComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
