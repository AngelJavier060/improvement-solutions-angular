...
@Component({
  selector: 'app-editar-marca-vehiculo',
  templateUrl: './editar-marca-vehiculo.component.html',
  styleUrls: ['./editar-marca-vehiculo.component.scss']
})
export class EditarMarcaVehiculoComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
  ...
  constructor(
    ...
    private service: MarcaVehiculoService,
