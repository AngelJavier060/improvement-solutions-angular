...
@Component({
  selector: 'app-editar-propietario-vehiculo',
  templateUrl: './editar-propietario-vehiculo.component.html',
  styleUrls: ['./editar-propietario-vehiculo.component.scss']
})
export class EditarPropietarioVehiculoComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
  ...
  constructor(
    ...
    private service: PropietarioVehiculoService,
