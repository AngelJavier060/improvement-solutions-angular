...
@Component({
  selector: 'app-editar-tipo-combustible',
  templateUrl: './editar-tipo-combustible.component.html',
  styleUrls: ['./editar-tipo-combustible.component.scss']
})
export class EditarTipoCombustibleComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
