...
@Component({
  selector: 'app-editar-pais-origen',
  templateUrl: './editar-pais-origen.component.html',
  styleUrls: ['./editar-pais-origen.component.scss']
})
export class EditarPaisOrigenComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
  ...
  constructor(
    ...
    private service: PaisOrigenService,
