...
@Component({
  ...
  templateUrl: './editar-estado-carretera.component.html',
  styleUrls: ['./editar-estado-carretera.component.scss']
})
export class EditarEstadoCarreteraComponent implements OnInit {
  form: FormGroup;
  loading = true;
  saving = false;
  error = '';
