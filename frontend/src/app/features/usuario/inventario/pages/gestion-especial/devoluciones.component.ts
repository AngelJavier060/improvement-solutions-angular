...
@Component({
  ...
  template: `<div class="page-container"><div class="page-header"><h1><i class="fas fa-undo"></i> Devoluciones</h1><p>Gestiona devoluciones de productos</p></div><div class="page-content"><div class="alert alert-info"><i class="fas fa-info-circle"></i><span>En construcción</span></div></div></div>`,
