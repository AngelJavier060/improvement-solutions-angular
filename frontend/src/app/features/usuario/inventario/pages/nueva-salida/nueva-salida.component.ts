  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        <h1><i class="fas fa-minus"></i> Nueva Salida</h1>
        <p>Registra salidas de productos del inventario</p>
      </div>
      <div class="page-content">
        <div class="alert alert-info">
          <i class="fas fa-info-circle"></i>
          <span>Esta sección está en construcción. Aquí podrás registrar salidas de inventario.</span>
        </div>
      </div>
    </div>
  `,
